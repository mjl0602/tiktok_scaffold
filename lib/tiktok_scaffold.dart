...
class _TikTokScaffoldState extends State<TikTokScaffold>
  ...
  TikTokScaffoldController get _controller =>
      widget.controller ?? defaultController;
  var defaultController = TikTokScaffoldController();

  @override
  void initState() {
    _controller?._onAnimateToPage = animateToPage;
    super.initState();
  }
